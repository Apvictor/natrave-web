...
function Profile() {
  ...
  return (
    <>
      <Header>
        <button className="p-2 cursor-pointer font-bold" onClick={() => logout()}>
          Sair
        </button>
      </Header>
      ...
      <main className="space-y-6">
        <section id="header" className="bg-red-500 text-white">
          <div className="container max-w-xl space-y-8 p-4">
            <a href="/dashboard">
              <Icon className="w-8" name="back" />
            </a>
            <h3 className="text-2xl font-bold">{user?.user}</h3>
          </div>
        </section>
